...
const SkeletonCard = ()=>{
    ...
    <Link href={''} className="md:w-[90%] md:max-w-[1200px] mx-auto mb-4 dark:text-white flex flex-col md:flex-row w-full">
        ...
        <div className="basis-[75%] grow ml-1 md:ml-4 mt-1">
            ...
            <Link href={''} className="text-grey md:w-[70%] dark:hover:text-white hover:text-black text-sm"><SekeltonText height="min-h-[0.8rem]" width="min-w-[25%] max-w-[25%]"/></Link>
            <div className="text-grey text-sm truncate-1 md:w-[70%]"><SekeltonText height="min-h-[0.8rem]" /></div>
        </div>
    </Link>
    </>
}
